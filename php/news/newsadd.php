...
<head>
    ...
    <title>ここちきんCMS管理画面/newsadd</title>
            ...
            <div class="globalmenu">
                <ul class="accordion">
                    ...
                    <li>
                        ...
                        <ul class="shutter-panel-collapse">
                            <li><a href="#">追加</a></li>
                            <li><a href="../gallery/galleryupdate.php">更新</a></li>
                            <li><a href="../gallery/gallerydelete.php">削除</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="shutter-panel-collapse">
                            <li><a href="reservationnotmail.php">予約未確定メール</a></li>
                            <li><a href="reservationmail.php">予約確定メール</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="shutter-panel-collapse">
                            <li><a href="#">追加</a></li>
                            <li><a href="newsupdate.php">更新</a></li>
                            <li><a href="newsdelete.php">削除</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!--globalmenuエリア-->
